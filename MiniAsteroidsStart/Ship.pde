...
void forward( float magnitude ) {
    ...
    //calculate a force to change acceleratioin
    //this function is called on Main file on keyPressed()
    PVector forward = new PVector(cos(angle)*magnitude*0.1,sin(angle)*magnitude*0.1);
